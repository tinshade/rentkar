      ...
      <section>
        ...
        <div className="dtop">
          <div className="d-flex container bg-white mt-3 pt-2 pb-2 mb-5 cround">
              <img src={c1} height="150px" width="150px" className="img-fluid dtop"/>
              ...
              <div className="container-fluid dtop faint" >
                  <div className="row mt-3">
                      <div className="col-md-5 col-lg-5 col-sm-12">
                          <img src={c2} className="mt-2 img-responsive" height="100px" width="100px"/>
                      </div>
              ...
              <div className="container-fluid dtop faint" >
                  <div className="row mt-3">
                      <div className="col-md-5 col-lg-5 col-sm-12">
                          <img src={c3} className="mt-2 img-responsive" height="100px" width="100px"/>
                      </div>
                      <div className="col-md-7 col-lg-7 col-sm-12 mt-3">
