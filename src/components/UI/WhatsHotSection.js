        ...
        <section>
            <div className="mtop">
                <div className="container mt-3">
                    <h2 className="secondary">WHAT'S HOT?
                        <i className="fas fa-2x fa-sort-down"></i>
                    </h2>
                </div>
                <div className="container mb-5">
                    <div className="gallery wh js-flickity container mt-5"
                        style={
                            {marginBottom: "5%"}
                    }>
                        <div className="gallery-cell col-lg-3 col-md-4 col-sm-12">
                            <div className="card shadow rounded-card">
                                <img alt=""
                                    src={wh4}
                                    height="205px"
                                    className="rounded-image card-img-top"/>
                                <div className="card-body float-left">
                                    <small className="text-muted">Starting at</small>
                                    <div className="card-header">
                                        <h5>₹ ****/day</h5>
                                    </div>
                                    <div className="card-footer dtop float-right">
